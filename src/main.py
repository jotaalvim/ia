...
menu_data = {
  'title': "VectorRace,", 'type': MENU, 'subtitle': "Selecione uma opção...",
  'options': [
    {
      'title': "Jogar ", 'type': MENU, 'subtitle': "Selecione uma opção...",
      'options': [
        {
          'title': "LeaderBoard", 'type': MENU, 
          'options': [
        ...
        {
          'title': "Pista 1", 'type': MENU, 'subtitle': "Selecione uma opção",
          'options': [
            { 'title': "Print da pista", 'type': COMMAND, 'command': '' },
            { 'title': "BFS", 'type': COMMAND, 'command': '' },
            { 'title': "Ridge Racer", 'type': COMMAND, 'command': '' },
            { 'title': "Snake", 'type': COMMAND, 'command': '' },
            { 'title': "Space Invaders", 'type': COMMAND, 'command': '' },
          ]
	    ...
	    {
          'title': "Pista 2", 'type': MENU, 'subtitle': "Selecione uma opção",
          'options': [
            { 'title': "Print da pista", 'type': COMMAND, 'command': '' },
            { 'title': "BFS", 'type': COMMAND, 'command': '' },
            { 'title': "Ridge Racer", 'type': COMMAND, 'command': '' },
        ...
        {
          'title': "Pista 3", 'type': MENU, 'subtitle': "Selecione uma opção",
          'options': [
            { 'title': "Print da pista", 'type': COMMAND, 'command': '' },
            { 'title': "BFS", 'type': COMMAND, 'command': '' },
            { 'title': "Ridge Racer", 'type': COMMAND, 'command': '' },
    ...
    { 'title': "Ajuda", 'type': COMMAND, 'command': 'uqm' },
  ]
}
